...
figure(12)
plot(Cur,Mom,X,Y,'r--',phi1,Mi1,'g-.',CurP,MomP,'--','LineWidth',3)
...
legend('Exact','Exact - bilinear fitted','Elastic-Perfect Plastic (Simple)','SAP2000','Location','NorthEastOutside');grid on;
%% Output Data to .txt file
fid = fopen('FiberISteelSectionMomentCurvature-OutPut.txt','w');
fprintf(fid,'*************************************************************\n');
