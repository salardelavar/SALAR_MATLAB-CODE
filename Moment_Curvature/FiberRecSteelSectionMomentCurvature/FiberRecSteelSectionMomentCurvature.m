...
fprintf(' Steel Section Ductility Rito (Simple) : %5.2f\n',SD1)
...
fid = fopen('FiberRecSteelSectionMomentCurvature-OutPut.txt','w');
fprintf(fid,'*************************************************************\n');
